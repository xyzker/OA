...
<body>
<!-- 1.获取到规则流程图 -->
<img style="position: absolute;top: 0px;left: 0px;" src="${pageContext.request.contextPath}/workflow/viewImage?deploymentId=<s:property value='deploymentId'/>&imageName=<s:property value='imageName'/>">
