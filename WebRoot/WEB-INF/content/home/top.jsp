...
<body CLASS=PageBody leftmargin=0 topmargin=0 marginwidth=0 marginheight=0>
	...
	<div id="Head1">
		...
		<div id="Head1Right">
			<s:if test="#session.user != null">
				<div id="Head1Right_UserName">
	                <img border="0" width="13" height="14" src="${pageContext.request.contextPath}/style/images/top/user.gif" /> 您好，<b><s:property value="#session.user.loginName"/></b>
				</div>
			</s:if>
			<s:else>
				<div id="Head1Right_UserName">
	               	 您尚未登录，请<a href="<s:url value='/user/loginUI'/>" style="color:red" target="_parent">登录</a>
				</div>
			</s:else>
        ...
        <div id="Head1Right_SystemButton">
            <a href="${pageContext.request.contextPath}/user/logout" target="_parent">
