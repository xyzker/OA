...
<head>
	...
	<script language="javascript" src="<s:url value='/script/jquery_treeview/jquery.treeview.js'/>"></script>
	<link type="text/css" rel="stylesheet" href="<s:url value='/style/blue/file.css'/>" />
	<link type="text/css" rel="stylesheet" href="<s:url value='/script/jquery_treeview/jquery.treeview.css'/>" />
...
<div id="Title_bar">
    <div id="Title_bar_Head">
        ...
        <div id="Title"><!--页面标题-->
            <img border="0" width="13" height="13" src="<s:url value='/style/images/title_arrow.gif'/>"/> 配置权限
        </div>
...
<div id=MainArea>
    ...
    <s:form action="setPrivilege" namespace="/role">
    	<s:hidden name="role.id"></s:hidden>
    
        <div class="ItemBlock_Title1"><!-- 信息说明 --><div class="ItemBlock_Title1">
        	<img border="0" width="4" height="7" src="<s:url value='/style/blue/images/item_point.gif'/>" /> 正在为【${role.name}】配置权限 </div> 
        </div>
